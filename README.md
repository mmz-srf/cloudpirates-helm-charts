...
| [Kafka](charts/kafka/)                                         | Distributed event streaming platform for high-performance data pipelines and streaming analytics (KRaft mode, no ZooKeeper)      | ![Version](https://img.shields.io/badge/dynamic/yaml?url=https://raw.githubusercontent.com/CloudPirates-io/helm-charts/main/charts/kafka/Chart.yaml&label=&query=version&prefix=v)                     |
